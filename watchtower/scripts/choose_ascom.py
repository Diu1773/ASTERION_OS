...
출력된 ProgID를 watchtower/config.toml의 [drivers.ascom]에 붙여넣을 것.

요구사항: ASCOM Platform + pywin32 (.venv-watchtower에 설치:
...
def main() -> int:
    try:
        ...
        print("pywin32가 없습니다:  .venv-watchtower\\Scripts\\pip install pywin32")
        return 1
